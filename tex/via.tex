...
\begin{leftbar}
    NOTE: While the \jr\ has a single VIA, the \fk\ has two VIA chips. The second VIA chip is located at 0xDB00. The purpose of this second VIA is to manage the built-in keyboard of the \fk. The keyboard/GPIO header pins on the \jr\ are moved to VIA1 and include some additional I/O pins. See page \pageref{sec_f256k_kbd} for a more complete description of the keyboard.
\end{leftbar}
