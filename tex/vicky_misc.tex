...
\begin{table}[ht]
    \begin{center}
        \begin{tabular}{|c|c|c|c|c|c|c|c|c|c|c|} \hline
            ...
            \verb+0xD30A+ & R & XY\_BANK & B7 & B6 & B5 & B4 & B3 & B2 & B1 & B0 \\ \hline

            \verb+0xD30B+ & R & \multirow{3}{*}{XY\_AD} & AD7 & AD6 & AD5 & AD4 & AD3 & AD2 & AD1 & AD0 \\ \cline{1-2}\cline{4-11}
            \verb+0xD30C+ & R & & AD15 & AD14 & AD13 & AD12 & AD11 & AD10 & AD9 & AD8 \\ \cline{1-2}\cline{4-11}
            \verb+0xD30D+ & R & & \multicolumn{6}{|c|}{---} & AD17 & AD16 \\ \hline
        \end{tabular}
    \end{center}
