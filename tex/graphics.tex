...
\begin{leftbar}
NOTE: Pixel data for all graphics modes can be stored anywhere in the initial system RAM. For the \jr\ RevB board and the \fk, this means the pixel data can be stored anywhere in the first 512KB of system address space. For the \jr\ RevA boards, however, pixel data may only be stored in the first 256KB of system address space, since the RevA boards were built with only 256KB of system RAM.
\end{leftbar}
