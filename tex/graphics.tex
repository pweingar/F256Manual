...
lut_loop:   ldy #0
            ...
            iny                 ; Y points to the green component now
            pha                 ; Save the blue component
            eor #$ff
            inc a
            pha                 ; Calculate and save the red component
            lda #0

            sta (pointer),y     ; Set the green component
            iny                 ; Y points to the red component now
            pla                 ; Get the red component
            sta (pointer),y     ; Set the red component
            pla                 ; Get the blue component back

            inc a               ; Go to the next color
            beq lut_done        ; If we are back to 0, we're done with the LUT
